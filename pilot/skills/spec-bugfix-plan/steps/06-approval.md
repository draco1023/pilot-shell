...
**If `PILOT_MODEL_SWITCH_ENABLED` is `"false"`:** do NOT call `ExitPlanMode`. Invoke `Skill(skill='spec-implement', args='<plan-path>')` directly — implementation continues on the active model.
<!-- /CC-ONLY -->
<!-- CODEX-START
