...
3. Handle response — **match strictly, never auto-approve ambiguous input:**
   - **Approve:** Response is one of: "Approve", "approve", "lgtm", "looks good" → proceed to Step 11. (Do NOT treat a bare "continue"/"proceed" as approval — those are routine resume nudges, not a verification sign-off.)
